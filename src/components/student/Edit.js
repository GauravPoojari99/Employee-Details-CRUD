    ...
    <Grid item md={6} xs={12}>
     ...
     <form>
      <Grid container spacing={2}>
       ...
       <Grid item xs={12} sm={6}>
        <TextField autoComplete="username" name="username" variant="outlined" required fullWidth id="username" label="Name" value={student.username} onChange={e => onTextFieldChange(e)} />
       </Grid>
       <Grid item xs={12}>
